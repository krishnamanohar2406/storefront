...
from store.models import Cart, CartItem, Customer, Order, Product,Collection, ProductImage, Review, Address
from store.pagination import DefaultPagination
from store.serializers import AddCartItemSerializer, AddressSerializer, CartItemSerializer, CartSerializer, CollectionSerializer, CreateOrderSerializer, CustomerSerializer, OrderItemSerializer, OrderSerializer, ProductImageSerializer, ProductSerializer ,ReviewSerializer, UpdateCartItemSerializer, UpdateOrderSerializer,RazorpayVerificationSerializer,EmptySerializer
...
class CartViewSet(ModelViewSet):
    ...
    def checkout(self, request, pk=None):
        ...
        serializer = CreateOrderSerializer(
            data={'cart_id': cart_id, 'address_id': request.data.get('address_id')},
